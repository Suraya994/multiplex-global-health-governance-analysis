...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Journal-Ready Split-Figure Package
  ─────────────────────────────────────────────────────────────────────────────
...
parser = argparse.ArgumentParser(
    description="Generate journal-ready split figures from the 100-country governance panels."
)
...
# ─────────────────────────────────────────────────────────────────────────────
#  JOURNAL THEME  (enlarged fonts, high contrast — applied per-figure)
# ─────────────────────────────────────────────────────────────────────────────
JOURNAL_RC = {
    "figure.facecolor":   BG,
    "axes.facecolor":     BG,
...
def style_ax(ax, xlabel="", ylabel="", title="", title_color=C3, grid=True):
    """Apply consistent journal polish to an axis."""
    if title:
...
with open(caption_path, "w", encoding="utf-8") as f:
    ...
    f.write("Journal-Ready Split Figure Package — Academic Caption Notes\n")
    f.write("=" * 78 + "\n\n")
